...
> Nota: la confirmacion por correo electronico (antes referida como "RF-11") esta **fuera del alcance** del modulo de agenda segun `docs/01_problem_definition/system_context.md`; por eso no se lista como RF relacionado.
---
